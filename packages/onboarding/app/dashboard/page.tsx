                      ...
                      <div className="space-y-4">
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                          ...
                          {app.technical_interview_score > 0 && (
                            <div className="bg-slate-50 p-3 rounded-lg">
                              ...
                              <p className="font-semibold text-lg">{app.technical_interview_score}/100</p>
                            </div>
                          )}
                        ...
                        <div className="flex gap-2">
                          ...
                          {app.status === 'technical_interview' && (
                            <Button size="sm" onClick={() => router.push(`/interview/technical/${app.id}`)}>
                              <MessageSquare className="h-4 w-4 mr-2" />
                              Start Technical Interview
                            </Button>
                          )}
                          {app.status === 'hr_interview' && (
                            <Button size="sm" onClick={() => router.push(`/interview/hr/${app.id}`)}>
                              <MessageSquare className="h-4 w-4 mr-2" />
                              Start HR Interview
                            </Button>
                          )}
